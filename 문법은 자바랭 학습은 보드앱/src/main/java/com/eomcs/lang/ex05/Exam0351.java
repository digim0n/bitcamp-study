...
//# 비트 연산자 & 를 이용하여 % 연산 구현하기 --->나누기 하는거보다 속도가 빨라서 이거 실무에서 많이 쓴다.
//
public class Exam0351 {
  public static void main(String[] args) {

    System.out.println(54 % 2);
    System.out.println(54 & 0b0000_0001); // 요거 실무에서 바로 윗줄꺼보다 많이 쓴다. 요거는 홀순지 짝순지 값을 알아내려는거구나 하면된다.
    ...
    // & 연산자를 이용하여 그 값의 하위 1비트 값만 추출하면 된다. //맨 끝의 1비트만 추출
    // 예)
    //    0011 0110 (54)
    //  & 0000 0001 (뒤의 1비트의 값을 추출)
    // --------------
    //    0000 0000 추출된 값은 0이다. 즉 나머지가 없다. 2진수에서는 (맨뒷자리)나머지가 0이냐 1이냐만 구하면 되고 그게 홀수짝수 구분되는거자너
    //           ㄴ> 마스크 효과라고 한다. ( 거름종이 효과 ) -->값을 차단하는거
    //    0011 0101 (53)
    //  & 0000 0001
    // --------------
    //    0000 0001 (나머지는 1이다)
...
//System.out.println(54 & 0b0000_0001); 요기서 54를 이진수로 변형  & 연산 수행 
